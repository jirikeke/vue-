  ...
  <div class="goods">
    ...
    <div class="bottom">
      <el-button
        ...
        >全选</el-button
      >
      <el-button type="primary" size="small" @click="unselectAll"
        >反选</el-button
      >

      <el-button type="primary" size="small" @click="handleDeleteAll"
        >批量删除</el-button
      >
    </div>
    <!-- 3. 分页 -->
...
// import batchDelete from '@/api/index.js'
export default {
  components: {
    MyPagination,
    GoodsDialog
  ...
  methods: {
    ...
    selectAll() {
      ...
      this.$refs.allRef.disabled = true
    },
    //反选
    unselectAll() {
      this.$refs.tableRef.clearSelection()
      this.$refs.allRef.disabled = false
    },
