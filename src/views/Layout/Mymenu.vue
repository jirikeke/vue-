  ...
  <div>
    ...
    >
      <el-menu-item>
        ...
        <span slot="title">{{ $t('project.title') }}</span>
      </el-menu-item>
      <el-menu-item index="/">
      ...
      <el-submenu index="/goods">
        ...
        <el-menu-item index="/goods/goods-list">
          ...
          <span slot="title">{{ $t('menu.goodslist') }}</span>
        </el-menu-item>
        <el-menu-item index="/goods/goods-verify">
          <i class="el-icon-menu"></i>
          <!-- <span slot="title">商品审核</span> -->
          <span slot="title">{{ $t('menu.goodscheck') }}</span>
        </el-menu-item>
      </el-submenu>
      ...
      <el-submenu index="/order">
        ...
        <el-menu-item-group>
          ...
          <el-menu-item index="/order/order-back">
            ...
            <span slot="title">{{ $t('menu.returngoods') }}</span>
          </el-menu-item>
        </el-menu-item-group>
      </el-submenu>
    </el-menu>
